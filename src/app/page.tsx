...
export default function Home() {
  ...
  useEffect(() => {
    ...
    fetchButtonPresses();
    const refreshTime = setInterval(fetchButtonPresses, 2000);

    return () => clearInterval(refreshTime);
  }, []);

  return (
    <main className="items-center justify-center min-h-screen bg-pink-100 text-gray-800">
      {/* Header */}
      <header className="bg-pink-300 text-white text-center shadow-lg">
        <h1 className="text-4xl font-extrabold">Habit Rabbit</h1>
      </header>
